...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RankingpremiumPokerclubsPageModule", function() { return RankingpremiumPokerclubsPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rankingpremium_pokerclubs__ = __webpack_require__(820);
...
var RankingpremiumPokerclubsPageModule = /** @class */ (function () {
    function RankingpremiumPokerclubsPageModule() {
    }
    RankingpremiumPokerclubsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__rankingpremium_pokerclubs__["a" /* RankingpremiumPokerclubsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["b" /* IonicImageViewerModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__rankingpremium_pokerclubs__["a" /* RankingpremiumPokerclubsPage */]),
            ],
            providers: [
    ...
    ], RankingpremiumPokerclubsPageModule);
    return RankingpremiumPokerclubsPageModule;
}());

//# sourceMappingURL=rankingpremium-pokerclubs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RankingpremiumPokerclubsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery__ = __webpack_require__(760);
...
var RankingpremiumPokerclubsPage = /** @class */ (function () {
    function RankingpremiumPokerclubsPage(navCtrl, navParams, platform, globalvars, clientrest, alertCtrl, loadingController) {
    ...
    RankingpremiumPokerclubsPage.prototype.ionViewDidLoad = function () {
        this.getRanking();
    };
    RankingpremiumPokerclubsPage.prototype.ionViewDidEnter = function () {
        this.initializeBackButtonCustomHandler();
    };
    RankingpremiumPokerclubsPage.prototype.ionViewWillLeave = function () {
        this.unregisterBackButtonAction && this.unregisterBackButtonAction();
    };
    RankingpremiumPokerclubsPage.prototype.initializeBackButtonCustomHandler = function () {
        var _this = this;
    ...
    RankingpremiumPokerclubsPage.prototype.botaoVoltarAndroid = function () {
        this.navCtrl.pop();
    };
    RankingpremiumPokerclubsPage.prototype.getRanking = function () {
        var _this = this;
        var dataParam = {
            'club_id': this.globalvars.getdadosClubeAtual()["id"],
            'user_id': this.globalvars.getidUsuario()
        };
        this.clientrest.getRankings(dataParam).then(function (data) {
            if (data["result"] == "S") {
                _this.rankings = data["items"];
                //this.ranking = this.returnListaTorneios(this.ranking);
            }
            else {
                _this.CriaAlerta("Ranking", data["message"]);
                _this.navCtrl.pop();
            }
        });
    };
    RankingpremiumPokerclubsPage.prototype.CriaAlerta = function (titulo, subtitulo) {
    ...
    */
    RankingpremiumPokerclubsPage.prototype.openRanking = function (idRanking, nomeRanking) {
        var etapasRanking = [];
        __WEBPACK_IMPORTED_MODULE_4_jquery__["each"](this.rankings, function (index, value) {
            if (parseInt(idRanking) == parseInt(value["id"])) {
                ...
                var rankingSteps = value["steps"];
                __WEBPACK_IMPORTED_MODULE_4_jquery__["each"](rankingSteps, function (index, value) {
                    etapasRanking.push({
                        idtorneio: idRanking,
                        idetapa: value["id"],
    ...
    RankingpremiumPokerclubsPage.prototype.loadingPage = function (pageName, pageParams) {
        var _this = this;
    ...
    RankingpremiumPokerclubsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-rankingpremium-pokerclubs',template:/*ion-inline-start:"C:\Roots\SAINTEC\pokerclubs\src\pages\rankingpremium-pokerclubs\rankingpremium-pokerclubs.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>PokerClubs - Ranking</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-item-divider class="ranking-list-divider">\n      Toque no torneio para visualizar o ranking\n    </ion-item-divider>\n    <ion-item class="ranking-list-itens" *ngFor="let ranking of rankings" (click)="openRanking(ranking.id, ranking.title)">      \n      <ion-icon name="trophy"></ion-icon>\n      &nbsp;&nbsp;\n      <span class="nome-ranking">{{ ranking.title }}</span>\n    </ion-item>\n  </ion-list>\n</ion-content>\n\n\n\n'/*ion-inline-end:"C:\Roots\SAINTEC\pokerclubs\src\pages\rankingpremium-pokerclubs\rankingpremium-pokerclubs.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_3__providers_global_vars_global_vars__["a" /* GlobalVarsProvider */], __WEBPACK_IMPORTED_MODULE_2__providers_clientrest_pokerclubs_clientrest_pokerclubs__["a" /* ClientrestPokerclubsProvider */],
    ...
    return RankingpremiumPokerclubsPage;
}());

//# sourceMappingURL=rankingpremium-pokerclubs.js.map
