...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatsPokerclubsPageModule", function() { return ChatsPokerclubsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_pipes_relative_time__ = __webpack_require__(790);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_components_autosize__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_fire__ = __webpack_require__(749);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_fire_database__ = __webpack_require__(753);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__chats_pokerclubs__ = __webpack_require__(807);
...
var ChatsPokerclubsPageModule = /** @class */ (function () {
    function ChatsPokerclubsPageModule() {
    }
    ChatsPokerclubsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_6__chats_pokerclubs__["a" /* ChatsPokerclubsPage */],
                __WEBPACK_IMPORTED_MODULE_2__providers_pipes_relative_time__["a" /* RelativeTime */],
                __WEBPACK_IMPORTED_MODULE_3__providers_components_autosize__["a" /* Autosize */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_4__angular_fire__["a" /* AngularFireModule */].initializeApp(firebaseConfig),
                __WEBPACK_IMPORTED_MODULE_5__angular_fire_database__["b" /* AngularFireDatabaseModule */],
                //AngularFireStorageModule,
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_6__chats_pokerclubs__["a" /* ChatsPokerclubsPage */]),
            ],
            providers: [
                //FileTransferObject,
                //File,
    ...
    ], ChatsPokerclubsPageModule);
    return ChatsPokerclubsPageModule;
}());

//# sourceMappingURL=chats-pokerclubs.module.js.map
...
var isDate = __webpack_require__(794)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_date_fns_distance_in_words_to_now__ = __webpack_require__(791);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_date_fns_locale_pt_index_js__ = __webpack_require__(803);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_date_fns_locale_pt_index_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_date_fns_locale_pt_index_js__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RelativeTime = /** @class */ (function () {
    ...
    RelativeTime.prototype.transform = function (value) {
        ...
        if (!value)
            return '';
        return __WEBPACK_IMPORTED_MODULE_1_date_fns_distance_in_words_to_now__(value, { addSuffix: args[0], locale: __WEBPACK_IMPORTED_MODULE_2_date_fns_locale_pt_index_js__ });
    };
...
var distanceInWords = __webpack_require__(792)
...
var compareDesc = __webpack_require__(793)
var parse = __webpack_require__(761)
var differenceInSeconds = __webpack_require__(795)
var differenceInMonths = __webpack_require__(797)
var enLocale = __webpack_require__(800)
...
var differenceInMilliseconds = __webpack_require__(796)
...
var parse = __webpack_require__(761)
var differenceInCalendarMonths = __webpack_require__(798)
var compareAsc = __webpack_require__(799)
...
var buildDistanceInWordsLocale = __webpack_require__(801)
var buildFormatLocale = __webpack_require__(802)
...
var buildFormattingTokensRegExp = __webpack_require__(781)
...
var buildDistanceInWordsLocale = __webpack_require__(804)
var buildFormatLocale = __webpack_require__(805)
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChatsPokerclubsPage; });
/* unused harmony export snapshotToArray */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_global_vars_global_vars__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_fire_database__ = __webpack_require__(753);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_loading_loading__ = __webpack_require__(305);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatsPokerclubsPage = /** @class */ (function () {
    function ChatsPokerclubsPage(navCtrl, navParams, globalvars, alertCtrl, loadingController, platform, toastController, angularFireDB, loadingCtrl) {
        ...
        this.data = { tipo: '', jogador: '', mensagem: '' };
        this.chats = [];
        this.nicknameJogador = '';
        this.toggled = false;
        this.offStatus = false;
        this.loadingCtrl.presentLoadingCircle1();
    }
    ChatsPokerclubsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    ChatsPokerclubsPage.prototype.ionViewWillEnter = function () {
        this.initializeBackButtonCustomHandler();
    };
    ChatsPokerclubsPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.loadingCtrl.dismiss().then(function () {
            setTimeout(function () {
                _this.loadingCtrl.presentLoadingFicha3();
                _this.initializeChat();
            }, 500);
        });
    };
    ChatsPokerclubsPage.prototype.ionViewWillLeave = function () {
        this.unregisterBackButtonAction && this.unregisterBackButtonAction();
    };
    ChatsPokerclubsPage.prototype.initializeChat = function () {
        var _this = this;
        this.nomeClube = this.navParams.get("clube");
        this.nomeTorneio = this.navParams.get("torneio");
        this.keyTorneio = this.navParams.get("cod");
        ...
        this.angularFireDB.database.ref('chatrooms/' + this.nomeClube + '/' + this.nomeTorneio).on('value', function (resp) {
            _this.chats = [];
    ...
    ChatsPokerclubsPage.prototype.sendMensagem = function () {
        var _this = this;
        if (this.data.mensagem !== '') {
            var textWithLineBreaks = this.data.mensagem;
            textWithLineBreaks = textWithLineBreaks.replace(/\n/g, '<br \/>');
            var newData = this.angularFireDB.database.ref('chatrooms/' + this.nomeClube + '/' + this.nomeTorneio + '/').push();
            newData.set({
                cod: this.idJogador,
    ...
    ChatsPokerclubsPage.prototype.resize = function () {
        var element = this.myMessage['_elementRef'].nativeElement.getElementsByClassName("text-input")[0];
        element.style.height = 'auto';
        this.myMessage['_elementRef'].nativeElement.style.height = 'auto';
    };
    ChatsPokerclubsPage.prototype.initializeBackButtonCustomHandler = function () {
        var _this = this;
        this.unregisterBackButtonAction = this.platform.registerBackButtonAction(function () {
            _this.botaoVoltarAndroid();
        }, 101);
    };
    ChatsPokerclubsPage.prototype.botaoVoltarAndroid = function () {
    ...
    ], ChatsPokerclubsPage.prototype, "contentArea", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* List */], { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */] }),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], ChatsPokerclubsPage.prototype, "chatList", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('myMessage'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], ChatsPokerclubsPage.prototype, "myMessage", void 0);
    ChatsPokerclubsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-chats-pokerclubs',template:/*ion-inline-start:"C:\Roots\SAINTEC\pokerclubs\src\pages\chats-pokerclubs\chats-pokerclubs.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{nomeTorneio}}<br><span class="clbname">{{nomeClube}}</span></ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #contentArea>\n  <ion-list>\n    <ion-item *ngFor="let chat of chats" no-lines>\n      <div class="chat-status" text-center *ngIf="chat.tipo===\'inscrito\'||chat.tipo===\'entrou\'||chat.tipo===\'saiu\';else mensagem">\n        <span class="chat-date">{{chat.data | relativeTime}}</span>\n        <span class="chat-content-center">{{chat.mensagem}}</span>\n      </div>\n      <ng-template #mensagem>\n        <div class="chat-mensagem" text-right *ngIf="chat.jogador===nomeJogador">\n          <div class="right-bubble">\n            <span class="msg-name">Você </span>\n            <span class="msg-date">{{chat.data | relativeTime}}</span>\n            <div [innerHtml]="chat.mensagem"></div>\n          </div>\n        </div>\n        <div class="chat-mensagem" text-left *ngIf="chat.jogador!==nomeJogador">\n          <div class="left-bubble">\n            <span class="msg-name">{{chat.jogador}} </span>\n            <span class="msg-date">{{chat.data | relativeTime}}</span>\n            <div [innerHtml]="chat.mensagem"></div>\n          </div>\n        </div>\n      </ng-template>\n    </ion-item>\n  </ion-list>\n</ion-content>\n<ion-footer>\n  <div class="tx1">\n      <ion-textarea #myMessage type="text" [(ngModel)]="data.mensagem" name="mensagem" placeholder="Digite sua mensagem" autocorrect autosize></ion-textarea>\n  </div>\n  <div class="bt1">\n    <div id="sendmessage" class="ic1" (click)="sendMensagem()"></div>\n  </div>\n</ion-footer>'/*ion-inline-end:"C:\Roots\SAINTEC\pokerclubs\src\pages\chats-pokerclubs\chats-pokerclubs.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_global_vars_global_vars__["a" /* GlobalVarsProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__angular_fire_database__["a" /* AngularFireDatabase */], __WEBPACK_IMPORTED_MODULE_4__providers_loading_loading__["a" /* LoadingProvider */]])
    ], ChatsPokerclubsPage);
    return ChatsPokerclubsPage;
}());
...
//# sourceMappingURL=chats-pokerclubs.js.map
