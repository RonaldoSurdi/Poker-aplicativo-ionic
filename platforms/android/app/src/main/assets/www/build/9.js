...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FotospremiumPokerclubsPageModule", function() { return FotospremiumPokerclubsPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fotospremium_pokerclubs__ = __webpack_require__(811);
...
var FotospremiumPokerclubsPageModule = /** @class */ (function () {
    function FotospremiumPokerclubsPageModule() {
    }
    FotospremiumPokerclubsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__fotospremium_pokerclubs__["a" /* FotospremiumPokerclubsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["b" /* IonicImageViewerModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__fotospremium_pokerclubs__["a" /* FotospremiumPokerclubsPage */]),
            ],
            providers: [
    ...
    ], FotospremiumPokerclubsPageModule);
    return FotospremiumPokerclubsPageModule;
}());

//# sourceMappingURL=fotospremium-pokerclubs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FotospremiumPokerclubsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(57);
...
var FotospremiumPokerclubsPage = /** @class */ (function () {
    function FotospremiumPokerclubsPage(navCtrl, navParams, clientrest, platform, photoViewer, globalvars, alertCtrl) {
    ...
    FotospremiumPokerclubsPage.prototype.ionViewDidLoad = function () {
        this.getFotosGaleria();
    };
    FotospremiumPokerclubsPage.prototype.ionViewDidEnter = function () {
        this.initializeBackButtonCustomHandler();
    };
    FotospremiumPokerclubsPage.prototype.ionViewWillLeave = function () {
        this.unregisterBackButtonAction && this.unregisterBackButtonAction();
    };
    FotospremiumPokerclubsPage.prototype.initializeBackButtonCustomHandler = function () {
        var _this = this;
    ...
    FotospremiumPokerclubsPage.prototype.botaoVoltarAndroid = function () {
        this.navCtrl.pop(); //setRoot("GaleriaFotospremiumPokerclubsPage");
    };
    FotospremiumPokerclubsPage.prototype.getFotosGaleria = function () {
        var _this = this;
        var dataParam = {
            'gallery_id': this.globalvars.getgaleriaFotosAtual(),
            'user_id': this.globalvars.getidUsuario()
        };
        this.clientrest.getFotosGaleriaClub(dataParam).then(function (data) {
            if (data["result"] == "S") {
                _this.fotos = data["items"];
            }
            else {
    ...
    FotospremiumPokerclubsPage.prototype.showZoomFoto = function (imagem, titulo) {
        this.photoViewer.show(imagem, titulo, { share: true });
    };
    FotospremiumPokerclubsPage.prototype.CriaAlerta = function (titulo, subtitulo) {
    ...
    FotospremiumPokerclubsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-fotospremium-pokerclubs',template:/*ion-inline-start:"C:\Roots\SAINTEC\pokerclubs\src\pages\fotospremium-pokerclubs\fotospremium-pokerclubs.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>PokerClubs - Fotos</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-card *ngFor="let foto of fotos">\n      <ion-card-content>\n        <p class="descricao-foto" [innerHTML]="foto.description"></p>\n        <p>&nbsp;</p>\n        <img [src]="foto.photo" (click)="showZoomFoto(foto.photo, foto.description)">        \n      </ion-card-content> \n    </ion-card>\n</ion-content>'/*ion-inline-end:"C:\Roots\SAINTEC\pokerclubs\src\pages\fotospremium-pokerclubs\fotospremium-pokerclubs.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_clientrest_pokerclubs_clientrest_pokerclubs__["a" /* ClientrestPokerclubsProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_3__ionic_native_photo_viewer__["a" /* PhotoViewer */], __WEBPACK_IMPORTED_MODULE_4__providers_global_vars_global_vars__["a" /* GlobalVarsProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], FotospremiumPokerclubsPage);
    return FotospremiumPokerclubsPage;
}());

//# sourceMappingURL=fotospremium-pokerclubs.js.map
